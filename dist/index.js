...
class Track {
     ...
     * Scrobble a single track, or a batch of tracks. 
     * @param {Object} params
     * @param {string} params.artist - The artist name.
     * @param {string} params.track - The track name.
     * @param {number} params.timestamp - The time the track started playing, in UNIX timestamp format (integer number of seconds since 00:00:00, January 1st 1970 UTC). This must be in the UTC time zone.
     * @param {string} [params.album] - The album name.
     * @param {string} [params.context] - Sub-client version (not public, only enabled for certain API keys).
     * @param {string} [params.streamId] - The stream id for this track received from the radio.getPlaylist service, if scrobbling Last.fm radio.
     * @param {0|1} [params.chosenByUser] - Set to 1 if the user chose this song, or 0 if the song was chosen by someone else (such as a radio station or recommendation service). Assumes 1 if not specified.
     * @param {number} [params.trackNumber] - The track number of the track on the album.
     * @param {string} [params.mbid] - The MusicBrainz Track ID.
